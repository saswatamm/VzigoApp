...
public class CheckInresponse {
    ...
    public CheckInresponse(String purpose, String status, String visitorId, String emailId, String address, String name, String clientId, String gender, String digitalSignature, boolean isCovidVaccinated, String city, String checkInTime, String whomToVisit, String dateOfBirth, String zipCode, String checkInDate, String phone, String govtId) {
        this.purpose = purpose;
        this.status = status;
        this.visitorId = visitorId;
        this.emailId = emailId;
